    ...
    const id = toast.success(
        <div className="relative w-full pr-19">
            ...
            <button
                ...
                className="absolute top-0 right-0 bg-white text-txt-system-success rounded-full p-1"
            >
                <X size={16} />
            </button>
        </div>,
...
export const toastError = (message: string) => {
    const id = toast.error(
        <div className="relative w-75 pr-19 ">
            ...
            <button
                onClick={() => toast.dismiss(id)}
                className="absolute top-0 right-0 bg-white text-txt-system-danger rounded-full p-1"
            >
                <X size={16} />
            </button>
        </div>,
        {
            duration: 3000,
            className: "bg-red-500 border border-red",
            icon: (
...
export const toastInfo = (message: string) => {
    const id = toast.info(
        <div className="relative w-75 pr-19">
            ...
            <button
                onClick={() => toast.dismiss(id)}
                className="absolute top-0 right-0 bg-white text-txt-system-information rounded-full p-1"
            >
                <X size={16} />
            </button>
        </div>,
...
export const toastWarning = (message: string) => {
    const id = toast.warning(
        <div className="relative w-75 pr-19">
            ...
            <button
                onClick={() => toast.dismiss(id)}
                className="absolute top-0 right-0 bg-white text-txt-system-warning rounded-full p-1"
            >
                <X size={16} />
            </button>
        </div>,
