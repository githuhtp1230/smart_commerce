        ...
        <Card className="shadow-md">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="flex">
                    <Input
                        placeholder="Voucher"
                        className="border border-gray-200 rounded-l-md rounded-r-none"
                    />
                    <Button className="border border-l-0 border-gray-200 bg-gray-100 hover:bg-gray-200 text-blue-500 rounded-r-md">
                        Apply
                    </Button>
                </div>
