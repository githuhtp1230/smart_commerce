  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-2 grid-rows-2 gap-4">
        ...
        <div className="row-span-1 cursor-pointer"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/attachments/gen-images/smart-commerce-banner-5-Uv0E6TQSWhf1tRjbESWkkvX8yTTX2a.png" alt="" className="rounded-lg h-full" /></div>
