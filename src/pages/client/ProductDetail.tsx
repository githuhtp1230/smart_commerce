...
const ProductDetail: React.FC = () => {
  ...
  const reviews = [
    {
      ...
      content:
        "I've been using this iMac for about a month now and I'm blown away by the display quality. The colors are incredibly vibrant and text is razor-sharp. Performance is excellent for my design work and the new speakers sound amazing. The thin design is also a huge plus for my small workspace.",
      image:
        "https://readdy.ai/api/search-image?query=A%20person%20working%20on%20a%20blue%20iMac%20in%20a%20modern%20home%20office%20setting%20with%20natural%20light%20coming%20through%20windows.%20The%20workspace%20is%20clean%20and%20minimalist%20with%20a%20few%20design%20books%20and%20a%20small%20plant.%20The%20image%20shows%20the%20iMac%20being%20used%20for%20graphic%20design%20work%20with%20vibrant%20colors%20on%20screen.&width=100&height=100&seq=5&orientation=squarish",
      helpful: 24,
      verified: true,
    },
    {
    ...
    },
    {
      ...
      content:
        "We upgraded from an older iMac and the difference is night and day. The screen is beautiful, startup is instant, and it handles everything from my husband's work applications to the kids' games without any slowdown. The built-in camera is great for video calls with family. Absolutely love the slim design too - it looks like a piece of art in our living room!",
      image:
        "https://readdy.ai/api/search-image?query=A%20family%20room%20setting%20with%20a%20blue%20iMac%20positioned%20on%20a%20wooden%20desk.%20The%20scene%20shows%20a%20cozy%20living%20space%20with%20a%20sofa%20visible%20in%20the%20background.%20The%20iMac%20screen%20displays%20a%20video%20call%20with%20family%20members%2C%20demonstrating%20its%20use%20as%20a%20family%20computer%20in%20a%20warm%2C%20inviting%20home%20environment.&width=100&height=100&seq=6&orientation=squarish",
      helpful: 31,
      verified: true,
      sellerResponse: {
        date: "May 16, 2025",
        content:
          "Thank you for your wonderful review, Sarah! We're delighted to hear how well the new iMac is serving your family's diverse needs. The improved camera was indeed designed with better video calling in mind, so we're glad you're enjoying that feature!",
      },
    },
  ];
  ...
  const specs = [
    ...
    {
      name: "Display",
      value: "24-inch 4.5K Retina display (4480 × 2520) with P3 and True Tone",
    },
    {
      name: "Camera",
      value: "1080p FaceTime HD camera with M2 image signal processor",
    },
    {
      name: "Audio",
      value: "Six-speaker system with force-cancelling woofers, Spatial Audio",
    },
    { name: "Connectivity", value: "Wi-Fi 6E (802.11ax), Bluetooth 5.3" },
    {
      name: "Ports",
      value:
        "2 Thunderbolt / USB 4 ports, 2 USB 3 ports, Gigabit Ethernet, 3.5mm headphone jack",
    },
    {
      name: "Dimensions",
      value:
        "Height: 18.1 inches (46.1 cm), Width: 21.5 inches (54.7 cm), Depth: 5.8 inches (14.7 cm)",
    },
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  24" iMac with Retina 4.5K display
                </h1>
                    ...
                    {[...Array(5)].map((_, i) => (
                      <i
                        ...
                        className={`fa-solid fa-star ${
                          i < 4.7 ? "text-amber-400" : "text-gray-300"
                        }`}
                      ></i>
                    ))}
                  </div>
              ...
              <div className="flex gap-4 mb-6">
                <Button
                  className="flex-1 py-6 text-base !rounded-button whitespace-nowrap cursor-pointer"
                  size="lg"
                >
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="h-12 w-12 !rounded-button whitespace-nowrap cursor-pointer"
                >
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Button
                      variant="link"
                      className="p-0 h-auto text-blue-600 mt-1 !rounded-button whitespace-nowrap cursor-pointer"
                    >
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <Tabs defaultValue="description">
            ...
            >
              ...
              <p>
                The new iMac features a stunning 24-inch 4.5K Retina display
                with 11.3 million pixels, P3 wide color gamut, and over a
                billion colors. This immersive display delivers vibrant,
                brilliant images with superb detail, making everything from
                photos and videos to web browsing and document editing look
                incredibly sharp and true to life.
              </p>
              <p>
                The M2 chip takes iMac's performance to a whole new level with
                faster CPU and GPU cores, a more powerful Neural Engine, and
                support for more unified memory. This translates to blazing-fast
                performance for everyday tasks, creative workflows, and gaming.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600">
                    ...
                    10-core GPU, and 16-core Neural Engine
                  </p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mb-4">
                  ...
                  <p className="text-gray-600">
                    4480 × 2520 resolution with P3 wide color gamut and True
                    Tone technology
                  </p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600">
                    Look your best on video calls with advanced image signal
                    processor
                  </p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600">
                    Six-speaker system with force-cancelling woofers and support
                    for Spatial Audio
                  </p>
                </div>
              </div>
                          ...
                          <CardContent className="p-6">
                            ...
                            <div className="flex items-center text-sm text-gray-500 mb-2">
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-gray-500 !rounded-button whitespace-nowrap cursor-pointer"
                              >
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-8">
                ...
                <div className="text-sm text-gray-500 mt-2">
                  {bundleSelected
                    ? "You save $49.00 compared to buying separately"
                    : ""}
                </div>
              </div>
            </div>
